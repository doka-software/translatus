...
fn t(key: &str) -> [&'static str; 5] {
    match key {
        ...
        "mcp.offer.what" => ["Registering lets it estimate, translate and annotate books for you by name.", "註冊之後，你可以直接用講的請它估價、翻譯、寫眉批。", "注册之后，你可以直接用讲的请它估价、翻译、写批注。", "登録すると、見積もり・翻訳・注釈を会話で頼めるようになります。", "등록하면 견적·번역·주석을 말로 요청할 수 있습니다."],
        ...
        "run.noteplan" => ["mapping the book to decide where notes belong…", "正在盤點全書、決定批註落點……", "正在盘点全书、决定批注落点……", "注をどこに置くか全体を確認中…", "주석을 어디에 둘지 책 전체를 살피는 중…"],
